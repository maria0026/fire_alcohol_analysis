...
def main(cli_args=None):
    ...
    parser.add_argument("--area_dataset", nargs="?", default="data/Wykaz_powierzchni_wg_stanu_na_01012025_ha_km2.xlsx",
                        help="dataset about alcohol consession", type=str)
    ...
    parser.add_argument("--plot", default=1, type=int, help="Parameter to set plotting, 0/1 (false/true)")
    ...
    with open(args.output_file, "w") as f:
        r_value = analysis.fire_alcohol(fire_dataset, alcohol_dataset, plot=bool(args.plot))
        f.write(
        ...
        r = analysis.alcohol_pedestrian(alcohol_dataset, population_dataset, pedestrian_accidents_dataset, plot=bool(args.plot))
        f.write(
            f"Wartość korelacji między liczbą koncesji a liczbą wypadków z udziałem pieszych na 100 tys ludnosci w województwach wynosi {round(r, 2)}. \n")
